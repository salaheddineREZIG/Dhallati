...
Revision ID: fcfe7ed6483a
Revises: 
Create Date: 2025-12-04 15:27:03.237168
...
def upgrade():
    ...
    sa.CheckConstraint('lost_item_id != found_item_id', name='ck_matches_different_items'),
    sa.CheckConstraint('match_score IS NULL OR (match_score >= 0 AND match_score <= 100)', name='ck_matches_score_range'),
    ...
    with op.batch_alter_table('matches', schema=None) as batch_op:
        batch_op.create_index('ix_matches_confirmed_score', ['is_confirmed', 'match_score'], unique=False)
    ...
    sa.CheckConstraint("contact_info GLOB '[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]'", name='ck_reports_contact_info_digits10'),
    sa.ForeignKeyConstraint(['item_id'], ['items.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['location_id'], ['locations.id'], ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['reporter_id'], ['users.id'], ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('item_id', name='uq_report_item')
    )
...
def downgrade():
    ...
    with op.batch_alter_table('matches', schema=None) as batch_op:
        ...
        batch_op.drop_index('ix_matches_confirmed_score')
